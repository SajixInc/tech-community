...
folder_path = r'C:\Users\vivif\Documents\anakapalli first page'  ## give pdf's folder path
...
mycollection = mydatabase['Anakapalli12']
mycollection2 = mydatabase['Anakapalli12']
